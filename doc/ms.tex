...
How many sources are in this image? Where are they located, how bright are they,
...
In this paper, we describe a new implementation of the \citet{starfield}
algorithm, which samples the posterior distribution for possible catalogs
given the data. The implementation is in C++ and makes use of the DNest4 package
